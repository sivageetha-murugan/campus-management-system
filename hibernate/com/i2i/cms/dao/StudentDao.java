...
public class StudentDao {
     ...
     *
     * @throws Student exception when the student details can not be inserted.
     */
     ...
     *
     * @throws Student exception when the student id is invalid or can not be accessed.
     */
     ...
     *
     * @throws Student exception when the student id to update can not be accessed or details not updated.
     */
