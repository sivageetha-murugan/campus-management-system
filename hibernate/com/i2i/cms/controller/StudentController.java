...
/*
 * This class is implemented to hadle the inputs from the user and the outputs to be displayed.
 ...
 * This class perfoms the certain operations on the input data such as add, retrieve, update and delete. 
 */
